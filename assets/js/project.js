        ...
        for (const item of project.gallery) {
          ...
          mediaDiv.addEventListener('click', () => {
            ...
            if (item.type === 'image') {
              ...
              const videoWidth = `min(90vw, calc(90vh * ${ratioW} / ${ratioH}))`;
              const videoHeight = `min(90vh, calc(90vw * ${ratioH} / ${ratioW}))`;
              const fitStyle = `width:${videoWidth}; height:calc(${videoHeight} + 56px); display:block; border-radius:12px; border:none;`;
